...
import DoctorsSelectionstep from "@/components/appointments/DoctorsSelectionstep";
...
function AppointmentsPage() {
  ...
  const { data: userAppointments = [] } = useUserAppointments(); // to keep user appointments up to date after booking
    ...
    bookAppointmentMutation.mutate(
      ...
      },
      {
        onSuccess: async (appointment) => {
          //store appointment details to show in confirmation modal
          setBookedAppointment(appointment);

          //send email using resend

          //set show confirmation modal to true
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="size-10 bg-primary/10 rounded-full flex items-center justify-center">
                    <img
                      src={appointment.doctor.imageUrl ?? "/default-avatar.png"}
