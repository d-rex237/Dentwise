        ...
        <div className="mb-12 overflow-hidden ">
          <div className="flex items-center justify-between bg-gradient-to-br from-primary/10 to-background rounded-3xl p-8 border border-primary/20">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Get Unlimited AI Consultation, Advanced features, and priority
            ...
            <div className="hidden lg:block">
              <div className="w-32 h-32 bg-gradient-to-br from-primary/20 rounded-full flex items-center justify-center">
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              include secure access and bank level security.
            </p>
          </div>
